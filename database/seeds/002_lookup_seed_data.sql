...
VALUES
    ...
    ('MILITARY_UAV_STRIKE', 'Military UAV — Strike / UCAV', 'MILITARY_UAV', 91) ON CONFLICT (code) DO NOTHING;
...
VALUES ('IN_PRODUCTION', 'In Production', 'Currently manufactured and delivered to customers.', 10),
       ...
       ('UNKNOWN', 'Unknown', 'Production / service status not established from available sources.', 99) ON CONFLICT (code) DO NOTHING;
...
VALUES ('PRODUCTION_STANDARD', 'Standard Production',
       ...
       ('CLASSIC_SERIES', 'Classic / Legacy Series',
        'Historical production series representing an earlier generation.', 70) ON CONFLICT (code) DO NOTHING;
...
VALUES ('FIXED_TRICYCLE', 'Fixed Tricycle',
       ...
       ('NONE_GLIDER', 'None (Glider / Sailplane)',
        'Mono-wheel or no gear; glider and motorglider convention.', 90) ON CONFLICT (code) DO NOTHING;
...
VALUES ('PISTON_RECIPROCATING', 'Piston / Reciprocating',
       ...
       ('NONE_GLIDER', 'None (Unpowered Glider)',
        'Unpowered glider or sailplane.', FALSE, FALSE, NULL, 99) ON CONFLICT (code) DO NOTHING;
...
VALUES ('AVGAS_100LL', '100LL Avgas',
       ...
       ('HYDROGEN', 'Hydrogen (LH2 / GH2)',
        'Cryogenic liquid or compressed gaseous hydrogen.', NULL, 60) ON CONFLICT (code) DO NOTHING;
...
VALUES ('WEIGHT_EMPTY', 'Basic Empty Weight',
       ...
       ('LOAD_FACTOR_NEG', 'Negative Load Factor Limit',
        'Maximum negative g-loading certificated limit.', NULL, 61) ON CONFLICT (code) DO NOTHING;
...
VALUES ('DIM_WINGSPAN', 'Wingspan (tip to tip)',
       ...
       ('DIM_TRACK_WIDTH', 'Main Gear Track Width',
        'Lateral distance between main gear contact points.', 'FT', 51) ON CONFLICT (code) DO NOTHING;
...
VALUES ('FAA', 'FAA',
       ...
       ('ANAC', 'ANAC',
        ...
        ARRAY['BRA'], 'https://www.anac.gov.br', 17) ON CONFLICT (code) DO NOTHING;
...
VALUES ('FAA_NORMAL', 'FAA Normal Category',
       ...
       ('MILITARY_SPEC', 'Military Specification',
        'Airworthiness governed by applicable MIL-SPEC.', NULL, 30) ON CONFLICT (code) DO NOTHING;
...
-- -----------------------------------------------------------------------------
INSERT INTO aircraft_ref.military_mission_types (code, label, sort_order)
VALUES ('AIR_SUPERIORITY', 'Air Superiority', 10),
       ...
       ('SPECIAL_OPERATIONS', 'Special Operations Aviation', 120) ON CONFLICT (code) DO NOTHING;

-- -----------------------------------------------------------------------------
-- aircraft_ref.weapon_categories (9 rows)
-- -----------------------------------------------------------------------------
INSERT INTO aircraft_ref.weapon_categories (code, label, sort_order)
VALUES ('AIR_TO_AIR', 'Air-to-Air Munitions', 10),
       ...
       ('SPECIAL_WEAPON', 'Special Weapon (Nuclear/CBRN)', 90) ON CONFLICT (code) DO NOTHING;

-- -----------------------------------------------------------------------------
-- aircraft_ref.hardpoint_position_types (7 rows)
-- -----------------------------------------------------------------------------
INSERT INTO aircraft_ref.hardpoint_position_types (code, label, sort_order)
VALUES ('WING_INBOARD', 'Wing — Inboard', 10),
       ...
       ('INTERNAL_BAY', 'Internal Weapons Bay', 70) ON CONFLICT (code) DO NOTHING;
...
VALUES ('AAM_SHORT_RANGE', 'Short-Range AAM', 'AIR_TO_AIR', 10),
       ...
       ('ECM_POD', 'Electronic Warfare Pod', 'ELECTRONIC', 60) ON CONFLICT (code) DO NOTHING;
...
VALUES ('EXCELLENT', 'Excellent',
       ...
       ('SALVAGE', 'Salvage',
        'Not airworthy; parts-only or rebuild project.', 1, 50) ON CONFLICT (code) DO NOTHING;
...
VALUES ('RECURRING', 'Recurring',
       ...
       ('EMERGENCY', 'Emergency AD',
        'Immediate action required before next flight.', 50) ON CONFLICT (code) DO NOTHING;

-- -----------------------------------------------------------------------------
-- aircraft_ref.sb_compliance_statuses (6 rows)
-- -----------------------------------------------------------------------------
INSERT INTO aircraft_ref.sb_compliance_statuses (code, label, sort_order)
VALUES ('MANDATORY', 'Mandatory', 10),
       ('RECOMMENDED', 'Recommended', 20),
       ('OPTIONAL', 'Optional', 30),
       ('COMPLIED', 'Complied With', 40),
       ('SUPERSEDED', 'Superseded', 50),
       ('NOT_APPLICABLE', 'Not Applicable', 60) ON CONFLICT (code) DO NOTHING;
...
VALUES ('EXCELLENT', 'Excellent',
       ...
       ('CRITICAL', 'Critical / Scarce',
        'Obsolete or near-obsolete; stockpile-only supply.', 1, 50) ON CONFLICT (code) DO NOTHING;
...
VALUES ('SCRAPED_WEB', 'Scraped Web Page',
       ...
       ('CALCULATED', 'Calculated / Derived',
        'Value derived from other source values by formula.', 80) ON CONFLICT (code) DO NOTHING;
...
VALUES ('AUTHORITATIVE', 'Authoritative',
       ...
       ('UNVERIFIED', 'Unverified',
        'Raw scraped or crowd-sourced; no independent verification.', 1, 50) ON CONFLICT (code) DO NOTHING;
...
VALUES ('OPEN', 'Open',
       ...
       ('DEFERRED', 'Deferred',
        'Acknowledged but deferred to a later curation cycle.', FALSE, 50) ON CONFLICT (code) DO NOTHING;
...
VALUES ('AIRCRAFT_FAMILY', 'Aircraft Family',
       ...
       ('MANUFACTURER', 'Manufacturer / Organisation',
        'aircraft_org', 'organizations', 60) ON CONFLICT (code) DO NOTHING;
...
VALUES ('PENDING', 'Pending',
       ...
       ('SUPERSEDED', 'Superseded',
        'A newer assertion from the same or better source now exists.', 50) ON CONFLICT (code) DO NOTHING;
...
-- -----------------------------------------------------------------------------
INSERT INTO aircraft_ref.mission_profile_types (code, label, sort_order)
VALUES ('PERSONAL_VFR_TOURING', 'Personal VFR Touring', 10),
       ...
       ('UNMANNED_SPECIAL_MISSION', 'Unmanned / Special Mission', 130) ON CONFLICT (code) DO NOTHING;
...
VALUES ('CRITERION_CRUISE_SPEED', 'Cruise Speed',
       ...
       ('CRITERION_WINGSPAN', 'Wingspan',
        NULL, NULL, 'DIM_WINGSPAN', NULL, 120) ON CONFLICT (code) DO NOTHING;
...
-- -----------------------------------------------------------------------------
INSERT INTO aircraft_ref.organization_types (code, label, sort_order)
VALUES ('MANUFACTURER', 'Aircraft Manufacturer', 10),
       ...
       ('INDUSTRY_ASSOCIATION', 'Industry Association', 50) ON CONFLICT (code) DO NOTHING;
...
VALUES ('SUBSIDIARY', 'Subsidiary',
       ...
       ('CONSORTIUM_MEMBER', 'Consortium Member',
        'Co-development and co-production consortium membership.', 70) ON CONFLICT (code) DO NOTHING;
...
-- -----------------------------------------------------------------------------
INSERT INTO aircraft_ref.systems_categories (code, label, sort_order)
VALUES ('NAVIGATION', 'Navigation Systems', 10),
       ...
       ('LIGHTING', 'Interior / Exterior Lighting', 150) ON CONFLICT (code) DO NOTHING;
...
VALUES ('STANDARD', 'Standard Equipment',
       ...
       ('REMOVED', 'Removed',
        'Was offered but production or STC has been discontinued.', 70) ON CONFLICT (code) DO NOTHING;

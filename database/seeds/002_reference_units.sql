-- =============================================================================
-- File: database/seeds/002_reference_units.sql
-- Phase 2 — seed data for aircraft_ref.unit_categories and
-- aircraft_ref.measurement_units.
-- MUST be applied BEFORE seeds/001_lookup_seed_data.sql because other
...
-- 0.1667 (1/6 lbs per gallon, representing avgas 100LL ≈ 6.02 lbs/gal).

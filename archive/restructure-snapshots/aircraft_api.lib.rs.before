...
use captcha::Captcha;
use aircraft_api_common::{comment::*, community::*, person::*, post::*, site::*, websocket::*};
use aircraft_utils::{ConnectionId, AircraftError};
use aircraft_websocket::{serialize_websocket_message, AircraftContext, UserOperation};
...
pub trait Perform {
  ...
  async fn perform(
    &self,
    context: &Data<AircraftContext>,
    websocket_id: Option<ConnectionId>,
  ) -> Result<Self::Response, AircraftError>;
}
